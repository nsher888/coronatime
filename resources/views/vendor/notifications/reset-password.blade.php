...
<body style="font-family: Inter;">
    <div style="max-width: 500px; margin: 0 auto;">
        <img src="{{ asset('/images/confirmation-img.png') }}" alt="Confirmation Image"
